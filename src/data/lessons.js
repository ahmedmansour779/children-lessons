...
// audios
import audioChoiceAudio from "../shared/chose.opus"
import coloring from "../shared/coloring.opus"
import delivery from "../shared/delivery.opus"
import audioE from "../shared/end.opus"
import description from "../shared/onePhoto.opus"
import play from "../shared/play.opus"
...
import { audio30_1, audio30_2, audio30_3 } from "./audio/30.js"
...
export const lessonMaze = [3, 9, 14, 19, 23, 26]
export const lessonDelivery = [1, 12]
export const lessonChoices = [2, 4, 6, 8, 11, 13, 15, 16, 18, 20, 21, 22, 24, 27, 29, 30]
export const lessonDescription = [15, 21]
export const lessonPuzzle = [5, 10, 7, 17, 25, 28]
...
const lessons = [
    {
        ...
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "صل ما في أ بما يتعلق بهِ في ب",
        imagePage1: image1_1,
        ...
        rightColumn: [image1_2_1, image1_4_2, image1_3_4],
        leftColumn: [image1_4_5, image1_4_4, image1_2_1],
        deliveryAudio: delivery,
        audio1: audio1_1,
        audio2: audio1_2,
        audio3: audio1_3,
        audio4: audio1_4,
    ...
    {
        id: 2,
        title1: "ماذا أفعل عند حدوث الحريق",
        title2: "ماذا أفعل عند حدوث الحريق",
        title3: "تصرفات غير صحيحة عند حدوث الحريق يجب أن ابتعد عنها",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        imageChoice1: image1_2_1,
        answerImages1: [image2_3_2, image2_3_3, image2_2_4],
        imageChoice2: image1_2_2,
        answerImages2: [image2_q_1, image2_q_2, image3_4_1],
        audio1: audio2_1,
        audio3: audio2_2,
        audioEnd: audioE,
        pages: 5,
    ...
    },
    {
        id: 3,
        title1: "رجل الإطفاء",
        title2: "وظيفة رجل الإطفاء",
        title3: "أدوات رجل الإطفاء",
        title4: "زي رجل الإطفاء",
        title5: "سيارة رجل الإطفاء",
        title6: "طريقة الوصول لرجل الإطفاء",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "هيا بنا نلعب",
        audioMaze: play,
    ...
    },
    {
        id: 4,
        title1: "التزاحم",
        title2: "ماذا تعني كلمة تزاحم",
        title3: "أماكن لا يجب التزاحم فيها في الروضة",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        answerImages1: [image4_3_1, image4_t_3],
        answerImages2: [image4_q_1, image4_q_2],
        audio1: audio4_1,
        audio2: audio4_2,
        audio3: audio4_3,
        audioEnd: audioE,
    ...
    },
    {
        id: 5,
        title1: "أدوات اللعب",
        title2: "ما هي أدوات اللعب داخل الروضة",
        title3: "كيفية أستخدام الالعاب بشكل سليم",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "هيا بنا نلون",
        coloringAudio: coloring,
        ...
        imagePuzzle: [image5_q_1, image5_q_2],
        audio1: audio5_1,
        audio2: audio5_2,
        audio3: audio5_3,
        audioEnd: audioE,
    ...
    },
    {
        ...
        title2: "ما هي أماكن اللعب في الروضة",
        title3: "السلوكيات التي يجب ولا يجب إتباعها في أماكن اللعب",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        answerImages1: [image6_3_2, image6_3_3, image6_3_4],
        answerImages2: [image11_2_1, image6_3_3, image6_2_4],
        audio1: audio6_1,
        audio2: audio6_2,
        audio3: audio6_3,
        audioEnd: audioE,
    ...
    },
    {
        ...
        imagePuzzle: [image7_q_1, image7_q_2],
        audio1: audio7_1,
        audio2: audio7_2,
        audio3: audio7_3,
        audioEnd: audioE,
    ...
    },
    {
        ...
        title2: "ما هي الاجهزة الكهربائية في الروضة",
        title3: "السلوكيات الخاطئة للتعامل مع الكهرباء في الروضة",
        title4: "السلوكيات الصحيحة للتعامل مع الكهرباء في الروضة",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        answerImages1: [image8_3_2, image8_3_1, image8_4_1],
        answerImages2: [image8_q_1, image8_2_1],
        audio1: audio8_1,
        audio2: audio8_2,
        audio3: audio8_3,
        audio4: audio8_4,
    ...
    },
    {
        ...
        title2: "تفتكروا يا اصدقائي ما هي اهمية التطعيمات",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "هيا بنا نلعب",
        audioMaze: play,
    ...
    },
    {
        ...
        title2: "ما هي التطعيمات الضرورية التي يجب الحصول عليها",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "هيا بنا نلون",
        coloringAudio: coloring,
        ...
        imagePuzzle: [image10_q_1, image10_q_2],
        audio1: audio10_1,
        audio2: audio10_2,
        audioEnd: audioE,
        pages: 4,
    ...
    },
    {
        ...
        title2: "أماكن تلقي التطعيمات",
        title3: "خطورة عدم تلقي التطعيمات",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        imageChoice1: image10_2_1,
        answerImages1: [image6_2_1, image5_2_5, image11_2_1],
        imageChoice2: image11_1_1,
        answerImages2: [image11_t_4, image11_3_3, image11_t_6],
        audio1: audio11_1,
        audio2: audio11_2,
        audio3: audio11_3,
        audioEnd: audioE,
    ...
    {
        id: 12,
        title1: "الأمراض التي تصيب اجسادنا",
        title2: "ما هي الأمراض التي قد تصيبنا",
        title3: "بعض العادات السليمه للوقايه من الأمراض",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "صل ما في أ بما يتعلق بهِ في ب",
        ...
        rightColumn: [image12_2_1, image12_2_3, image12_2_2],
        leftColumn: [image12_q_1, image12_t_4, image12_t_5],
        deliveryAudio: delivery,
        audio1: audio12_1,
        audio2: audio12_2,
        audio3: audio12_3,
    ...
    },
    {
        ...
        title2: "ما هي الأمراض الغير معدية",
        title3: "طرق الوقاية من الأمراض الغير معدية",
        title4: "التصرفات الصحيحة عند الاصابة من الأمراض الغير معدية",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        imageChoice1: image15_t_2,
        answerImages1: [image13_2_2, image13_3_1, image13_t_3],
        imageChoice2: image13_2_4,
        answerImages2: [image13_3_1, image13_2_2, image13_1_1],
        audio1: audio13_1,
        audio2: audio13_2,
        audio3: audio13_3,
        audio4: audio13_4,
    ...
    },
    {
        ...
        title2: "ما هي الأمراض المعدية",
        title3: "السلوكيات الصحيحة لتجنب الأمراض المعدية",
        title4: "ما هي التصرفات التي يجب إتباعها عند الأصابه بالأمراض المعدية",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "هيا بنا نلعب",
        audioMaze: play,
    ...
    {
        id: 15,
        title1: "الأصابات السطحية",
        title2: "اشكال الأصابات السطحية",
        title3: "أسباب الأصابات السطحية",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أذكر ما توضحة الصورة التي أمامك",
        ...
        answerImages1: [image15_q_1, image15_q_2, image15_q_3],
        audio1: audio15_1,
        audio2: audio15_2,
        audio3: audio15_3,
    ...
    {
        id: 16,
        title1: "كيفية التعامل مع الأصابات السطحية",
        title2: "طرق التعامل الصحيحة للتعامل مع الأصابات السطحية",
        title3: "افعال يجب الأبتعاد عنها لتجنب الأصابات السطحية",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        imageChoice1: image15_2_1,
        answerImages1: [image16_3_3, image16_3_2, image16_t_3],
        imageChoice2: image15_2_2,
        answerImages2: [image16_3_1, image16_t_6, image16_2_2],
        audio1: audio16_1,
        audio2: audio16_3,
        audio3: audio16_2,
        audioEnd: audioE,
    ...
    },
    {
        ...
        title2: "مصادر الكهرباء في منزلنا",
        title3: "الاجهزة الكهربائية في المنزل",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "هيا بنا نلون",
        coloringAudio: coloring,
        ...
        imagePuzzle: [image17_q_1, image17_q_2, image17_q_3],
        audio1: audio17_1,
        audio3: audio17_2,
        audioEnd: audioE,
        pages: 5,
    ...
    },
    {
        ...
        title2: "التصرفات الخاطئة أثناء التعامل مع الاجهزة الكهربائية في المنزل",
        title3: "التصرفات الصحيحة أثناء التعامل مع الاجهزة الكهربائية في المنزل",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        answerImages1: [image18_2_1, image18_2_2, image18_3_1],
        answerImages2: [image18_t_4, image18_t_5, image18_t_7],
        audio1: audio18_1,
        audio2: audio18_3,
        audio3: audio18_2,
        audioEnd: audioE,
    ...
    },
    {
        ...
        title2: "ما هي الأدوات الحادة",
        title3: "أخطار أستخدام الأدوات الحادة",
        title4: "كيف نتجنب مخاطر الأدوات الحادة",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        answerImages1: [image20_2_2, image20_3_1, image20_4_1],
        answerImages2: [image20_3_2, image20_2_1, image20_t_5],
        audio1: audio20_1,
        audio2: audio20_4,
        audio3: audio20_2,
        audio4: audio20_3,
    ...
    {
        id: 21,
        title1: "المواد القابلة للأشتعال",
        title2: "ما هي الأدوات القابلة للأشتعال",
        title3: "سلوكيات خاطئة عند أستخدام المواد القابلة للأشتعال",
        title4: "الأخطار الناجمه من المواد القابلة للأشتعال",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أذكر ما توضحة الصورة التي أمامك",
        descriptionAudio: description,
        ...
        answerImages1: [image21_q_1, image21_q_2],
        audio1: audio21_1,
        audio2: audio21_2,
        audio3: audio21_3,
        audio4: audio21_4,
    ...
    },
    {
        id: 22,
        title1: "الهواتف  ",
        title2: "سلوكيات خاطئة لا يجب إتباعها عند أستخدام الهواتف الذكية",
        title3: "أضرار الأفراض في أستخدام الهواتف الذكية",
        title4: "سلوكيات صحيحة يجب إتباعها عند أستخدام الهواتف الذكية",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        answerImages1: [image22_2_2, image22_2_3, image22_4_2],
        answerImages2: [image22_2_3, image22_2_2, image22_t_5],
        audio1: audio22_1,
        audio2: audio22_2,
        audio3: audio22_3,
        audio4: audio22_4,
    ...
    },
    {
        id: 23,
        title1: "الأنترنت",
        title2: "سلوكيات غير صحيحة عند أستخدام الأنترنت",
        title3: "أضرار أستخدام الأنترنت ب إفراط",
        title4: "نصائح عند أستخدام الأنترنت",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "هيا بنا نلعب",
        audioMaze: play,
    ...
    },
    {
        ...
        title2: "ما هي السلوكيات الصحيحة التي يجب إتباعها في اثناء السير علي الطريق",
        title3: "ما هي السلوكيات الخاطئة التي يجب الأبتعاد عنها اثناء السير علي الطريق",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        answerImages1: [image24_3_1, image24_3_3, image24_2_1],
        answerImages2: [image24_t_4, image24_t_6, image24_t_2],
        audio1: audio24_1,
        audio2: audio24_2,
        audio3: audio24_3,
        audioEnd: audioE,
    ...
    },
    {
        ...
        title3: "نصائح اثناء إتباع أشارات المرور",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        answerImages1: [image27_3_3, image27_3_1, image27_2_1],
        answerImages2: [image27_3_3, image27_3_1, image27_3_2],
        audio1: audio27_1,
        audio2: audio27_2,
        audio3: audio27_3,
        audioEnd: audioE,
    ...
    },
    {
        id: 28,
        title1: "شرطي المرور",
        title2: "وظيفة شرطي المرور",
        title3: "زي شرطي المرور",
        title4: "سيارة شرطي المرور",
        title5: "مكان عمل شرطي المرور",
        title6: "أدوات شرطي المرور",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "هيا بنا نلون",
        coloringAudio: coloring,
    ...
    },
    {
        ...
        title2: "ما هي الأماكن العامة التي توجد حولنا",
        title3: "السلوكيات الصحيحة التي يجب إتباعها في الأماكن العامة",
        title4: "السلوكيات الخاطئة التي يجب تجنبها في الأماكن العامة",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        answerImages1: [image29_4_1, image29_3_2],
        answerImages2: [image29_4_2, image29_3_1],
        audio1: audio29_1,
        audio2: audio29_2,
        audio3: audio29_3,
        audio4: audio29_4,
    ...
    },
    {
        ...
        title2: "ما هي السلوكيات الصحيحة عند أستخدام وسائل المواصلات",
        title3: "ما هي السلوكيات الخاطئة عند أستخدام وسائل المواصلات",
        titleEnd: "هيا بنا إلي بيتنا الدائري",
        titleQuizzes: "أختر الأجابة الصحيحة",
        choiceAudio: audioChoiceAudio,
        ...
        imagePage4: [image30_3_1, image30_3_2],
        ...
        answerImages1: [image30_3_1, image30_2_3],
        answerImages2: [image30_3_2, image30_2_2],
        audio1: audio30_1,
        audio2: audio30_2,
        audio3: audio30_3,
        audioEnd: audioE,
